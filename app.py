...
class ChromeAuto:
    def __init__(self):
        ...
        self.options.add_argument(r'user-data-dir=C:\novoselenium\Perfil\Default')
    ...
    def clica_sign_in(self):
        try:
            btn_sign_in = chrome.acessa('https://github.com/login')
            btn_sign_in.click()
        except Exception as e:
            print('Error ao clicar no Sign in: ', e)
    ...
    def log_out(self):
        try:
            deslogar = self.chrome.find_element_by_css_selector('body > div.position-relative.js-header-wrapper > header > div.Header-item.position-relative.mr-0.d-none.d-lg-flex > details > details-menu > form > button')
            deslogar.click()
        except Exception as e:
...
if __name__ == '__main__':
    ...
    chrome.clica_perfil()
    chrome.verifica_usuario('EvelynCleto')
